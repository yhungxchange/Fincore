...
<div class="welcome">
<h1>Confirm Cable Subscription</h1>
...
<span>Provider</span>
<strong><?= htmlspecialchars($_SESSION['cable_provider']) ?></strong>
</div>

<div class="summary-item">
<span>Smartcard Number</span>
<strong><?= htmlspecialchars($_SESSION['cable_smartcard']) ?></strong>
</div>

<div class="summary-item">
<span>Bouquet</span>
<strong><?= htmlspecialchars($_SESSION['cable_bouquet']) ?></strong>
</div>
...
<form action="cable-pin.php" method="GET">
